...
class OrderItemSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        OrderItem::create([
            'order_id' => 3,
            'variant_id' => 31,
            'name' => Product::find(Variant::find(31)->product_id)->name,
            'img' => Image::where('product_id', Variant::find(31)->product_id)->first()?->image,
            'variant' => Variant::find(31)->sku,
            'quantity' => 1,
            'price' => Variant::find(31)->price,
        ]);
