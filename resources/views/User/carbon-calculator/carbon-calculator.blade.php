<x-layout>
    <div class="flex items-center gap-[7vw] mt-[4vw] px-[10vw] mb-[5vw]">
        <div class="flex flex-col w-[40vw] gap-[1vw]">
            ...
            <button class="cursor-pointer w-fit px-[3vw] py-[0.75vw] rounded-[0.5vw] bg-orange-1 text-[1.2vw] font-bold text-white mt-[1vw]"><a href="/carbon-calculator/question">Take a Questioner</a></button>
        </div>
        <img src="{{ asset('images/carbon-footprint.png') }}" alt="elvinson" class="w-[35vw] h-[35vw] rounded-[2vw] object-cover">
    </div>
</x-layout>