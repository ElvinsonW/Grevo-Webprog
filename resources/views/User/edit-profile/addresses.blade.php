<x-layout>
    <div class="flex mx-[5vw] my-[2vw]">
        ...
        <div class="flex flex-col ml-[2vw] w-full">
            ...
            <div class="flex justify-between items-center mb-[3vw]">
                ...
                <button type="button" id="addAddressBtn" class="px-[1.5vw] py-[0.75vw] text-[1vw] rounded-[0.3vw] bg-[var(--color-green-3)] text-white hover:bg-[var(--color-green-2)]">
                    + Add New Address
                </button>
            </div>
    ...
    <div id="editAddressModal" class="fixed inset-0 bg-gray-600 bg-opacity-50 flex items-center justify-center z-50 hidden">
        <div class="bg-white rounded-[0.5vw] p-[2vw] shadow-lg w-[40vw] max-h-[90vh] overflow-y-auto relative">
            {{-- Close Button --}}
            <button id="closeEditModal" class="absolute top-[1vw] right-[1vw] text-gray-500 hover:text-gray-700 text-[1.5vw]">
                &times;
            </button>
            ...
            <form id="editAddressForm" method="POST">
                ...
                <div class="grid grid-cols-2 gap-[1.5vw] mb-[1.5vw]">
                    <div>
                        ...
                        <input type="text" name="recipient_name" id="edit_recipient_name"
                               class="w-full border border-gray-300 rounded-[0.3vw] p-[0.75vw] text-[0.9vw] focus:ring-blue-500 focus:border-blue-500 @error('recipient_name') border-red-500 @enderror"
                    ...
                    <div>
                        ...
                        <input type="text" name="phone_number" id="edit_phone_number"
                               class="w-full border border-gray-300 rounded-[0.3vw] p-[0.75vw] text-[0.9vw] focus:ring-blue-500 focus:border-blue-500 @error('phone_number') border-red-500 @enderror"
                ...
                <div class="mb-[1.5vw]">
                    ...
                    <input type="text" name="province" id="edit_province"
                           class="w-full border border-gray-300 rounded-[0.3vw] p-[0.75vw] text-[0.9vw] focus:ring-blue-500 focus:border-blue-500 @error('province') border-red-500 @enderror"
                ...
                <div class="grid grid-cols-2 gap-[1.5vw] mb-[1.5vw]">
                    <div>
                        ...
                        <input type="text" name="city" id="edit_city"
                               class="w-full border border-gray-300 rounded-[0.3vw] p-[0.75vw] text-[0.9vw] focus:ring-blue-500 focus:border-blue-500 @error('city') border-red-500 @enderror"
                    ...
                    <div>
                        ...
                        <input type="text" name="subdistrict" id="edit_subdistrict"
                               class="w-full border border-gray-300 rounded-[0.3vw] p-[0.75vw] text-[0.9vw] focus:ring-blue-500 focus:border-blue-500 @error('subdistrict') border-red-500 @enderror"
                ...
                <div class="mb-[1.5vw]">
                    ...
                    <input type="text" name="urban_village" id="edit_urban_village"
                           class="w-full border border-gray-300 rounded-[0.3vw] p-[0.75vw] text-[0.9vw] focus:ring-blue-500 focus:border-blue-500 @error('urban_village') border-red-500 @enderror"
                ...
                <div class="mb-[1.5vw]">
                    ...
                    <textarea name="street_address" id="edit_street_address" rows="3"
                              class="w-full border border-gray-300 rounded-[0.3vw] p-[0.75vw] text-[0.9vw] focus:ring-blue-500 focus:border-blue-500 @error('street_address') border-red-500 @enderror"
                ...
                <div class="mb-[1.5vw]">
                    ...
                    <div class="flex gap-[1vw]">
                        <label class="inline-flex items-center">
                            <input type="radio" name="label" value="Home" class="form-radio text-[var(--color-green-3)]" id="edit_label_home">
                        ...
                        <label class="inline-flex items-center">
                            <input type="radio" name="label" value="Work" class="form-radio text-[var(--color-green-3)]" id="edit_label_work">
                ...
                <div class="flex justify-end gap-[1vw]">
                    <button type="button" id="cancelEditModal" class="px-[1.5vw] py-[0.75vw] text-[1vw] border border-gray-300 rounded-[0.3vw] text-gray-700 hover:bg-gray-100">Cancel</button>
    ...
    <div id="addAddressModal" class="fixed inset-0 bg-gray-600 bg-opacity-50 flex items-center justify-center z-50 hidden">
        <div class="bg-white rounded-[0.5vw] p-[2vw] shadow-lg w-[40vw] max-h-[90vh] overflow-y-auto relative">
            {{-- Close Button --}}
            <button id="closeAddModal" class="absolute top-[1vw] right-[1vw] text-gray-500 hover:text-gray-700 text-[1.5vw]">
                &times;
            </button>
            ...
            <form id="addAddressForm" action="{{ route('addresses.store') }}" method="POST">
                ...
                <div class="grid grid-cols-2 gap-[1.5vw] mb-[1.5vw]">
                    <div>
                        <label for="add_recipient_name" class="block text-[0.9vw] font-medium text-gray-700 mb-[0.5vw]">Full Name</label>
                    ...
                    <div>
                        <label for="add_phone_number" class="block text-[0.9vw] font-medium text-gray-700 mb-[0.5vw]">Phone Number</label>
                ...
                <div class="mb-[1.5vw]">
                    <label for="add_province" class="block text-[0.9vw] font-medium text-gray-700 mb-[0.5vw]">Province</label>
                ...
                <div class="grid grid-cols-2 gap-[1.5vw] mb-[1.5vw]">
                    <div>
                        <label for="add_city" class="block text-[0.9vw] font-medium text-gray-700 mb-[0.5vw]">City</label>
                    ...
                    <div>
                        <label for="add_subdistrict" class="block text-[0.9vw] font-medium text-gray-700 mb-[0.5vw]">Subdistrict (Kecamatan)</label>
                ...
                <div class="mb-[1.5vw]">
                    <label for="add_urban_village" class="block text-[0.9vw] font-medium text-gray-700 mb-[0.5vw]">Urban Village (Kelurahan/Desa)</label>
                ...
                <div class="mb-[1.5vw]">
                    <label for="add_street_address" class="block text-[0.9vw] font-medium text-gray-700 mb-[0.5vw]">Street Name, Building, House Number</label>
                ...
                <div class="mb-[1.5vw]">
                    ...
                    <div class="flex gap-[1vw]">
                        <label class="inline-flex items-center">
                            <input type="radio" name="label" value="Home" class="form-radio text-[var(--color-green-3)]" id="add_label_home" {{ old('label') == 'Home' ? 'checked' : '' }}>
                            <span class="ml-[0.5vw] text-[0.9vw] text-gray-700 border border-gray-300 px-[1vw] py-[0.5vw] rounded-[0.3vw] cursor-pointer has-[:checked]:bg-[var(--color-green-1)] has-[:checked]:border-[var(--color-green-3)] has-[:checked]:text-[var(--color-green-3)]">Home</span>
                        </label>
                        <label class="inline-flex items-center">
                            <input type="radio" name="label" value="Work" class="form-radio text-[var(--color-green-3)]" id="add_label_work" {{ old('label') == 'Work' ? 'checked' : '' }}>
                            <span class="ml-[0.5vw] text-[0.9vw] text-gray-700 border border-gray-300 px-[1vw] py-[0.5vw] rounded-[0.3vw] cursor-pointer has-[:checked]:bg-[var(--color-green-1)] has-[:checked]:border-[var(--color-green-3)] has-[:checked]:text-[var(--color-green-3)]">Work</span>
                        </label>
                    </div>
                    @error('label')
                ...
                <div class="mb-[2vw]">
                    <label class="inline-flex items-center text-[0.9vw] text-gray-700">
                        <input type="checkbox" name="is_default" id="add_is_default" class="form-checkbox text-[var(--color-green-3)] rounded" {{ old('is_default') ? 'checked' : '' }}>
                        <span class="ml-[0.5vw]">Set as default address</span>
                    </label>
                    @error('is_default')
                        <p class="text-red-500 text-[0.8vw] mt-[0.25vw]">{{ $message }}</p>
                ...
                <div class="flex justify-end gap-[1vw]">
                    <button type="button" id="cancelAddModal" class="px-[1.5vw] py-[0.75vw] text-[1vw] border border-gray-300 rounded-[0.3vw] text-gray-700 hover:bg-gray-100">Cancel</button>
                    <button type="submit" class="px-[1.5vw] py-[0.75vw] text-[1vw] rounded-[0.3vw] bg-[var(--color-green-3)] text-white hover:bg-[var(--color-green-2)]">Add Address</button>
                </div>
            </form>
        </div>
    </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const editIsDefault = document.getElementById('edit_is_default');
            ...
            @if (session('show_add_modal') && $errors->any() && session('old_input_from_store'))
                ...
                if ("{{ old('is_default') }}" === "1") {
                    document.getElementById('add_is_default').checked = true;
                }
            @endif
            ...
            editAddressBtns.forEach(button => {
                button.addEventListener('click', function() {
                    ...
                    editIsDefault.checked = isDefault;
                    ...
                    editAddressForm.action = `/addresses/${id}`; // Adjust based on your route structure
            ...
            @if (session('show_edit_modal_id') && $errors->any())
                ...
                if (editModal) {
                    ...
                    editIsDefault.checked = oldEditData.is_default === '1';
